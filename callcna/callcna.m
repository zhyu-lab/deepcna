function callcna(lrcFile,segFile,outputDir,maxCN)
% 02/12/2022 by Zhenhua

%------Input and output------%
% lrcFile: file containing log read counts of all cells
% segFile: file defining breakpoints
...
%--------------load data--------------------
[data_lrc_all,data_chr_all,data_bin_all,bin_size] = load_data(lrcFile);
data_seg_sep = load_segs(segFile);
...
for k = 1:num_cell
    ...
    %------------------ call main funciton --------------------
    paras = main(init_paras,depend_table,thres_EM,max_iter,verbose);
